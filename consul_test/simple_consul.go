...
func main() {
	...
	flag.StringVar(&consul_addr, "consul_addr", "192.168.16.20:8500", "host:port of the service stuats monitor interface")
	flag.StringVar(&status_monitor_addr, "monitor_addr", "192.168.18.102:54321", "host:port of the service stuats monitor interface")
	flag.StringVar(&service_name, "service_name", "worker", "name of the service")
	flag.StringVar(&service_ip, "ip", "192.168.18.102", "service serve ip")
